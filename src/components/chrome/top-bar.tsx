...
export const TopBar = () => {
  ...
  return (
    <header className="relative z-10 flex items-center justify-between gap-3 border-b border-[var(--rule)] bg-[var(--bg)]/80 px-4 py-3 backdrop-blur md:gap-6 md:px-8 md:py-5">
      <div className="flex items-center gap-4">
        <Link to="/" className="group flex items-center gap-3">
          <Mark />
          <div className="flex flex-col leading-tight">
            <span className="font-display text-xl font-medium tracking-tight text-[var(--fg)] transition-colors group-hover:text-[var(--accent)] md:text-2xl">
              Garap
            </span>
            <span className="smallcaps hidden text-[var(--fg-3)] md:inline">personal&nbsp;broadsheet</span>
          </div>
        </Link>
      </div>
